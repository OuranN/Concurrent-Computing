...
public class Principal extends Application{
  ...
  public void start(Stage stage)throws Exception{
    FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/ferrovia.fxml"));
    Controller controle = new Controller();                                              // Instancia do controlador
    ...
    stage.setTitle("Desafio do Trem");                                                   // Titulo da Janela
