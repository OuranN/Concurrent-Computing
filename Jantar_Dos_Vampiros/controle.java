...
public class controle {
  ...
  private int verificarInicialização = 0;
  ...
  /* ***************************************************************
   * Metodo: resetAll
   * Funcao: O objetivo era retornar a aplicacao ao seu estado
   * 				inicial, mas nao consegui desenvolver de forma funcional,
   * 				por isso o metodo apenas pausa a aplciacao.
  ...
  public void start(ActionEvent event) throws InterruptedException {
    if (verificarInicialização == 0) {
      for (int i = 0; i < 5; i++) {
        filosofos[i].start();
      }
      verificarInicialização = 1;
    } else {
      for (int i = 0; i < 5; i++) {
        filosofos[i].retomar();
      }
  ...
  public void initialize() {
    ...
    //Configuracao para que os sliders que definem a velocidade com que os filosofos comem tenham um valor minimo=1 e valor maximo=1000
    ...
    //Configuracao para os sliders que definem a velocidade com que os filosofos pensam tenham um valor minimo=1 e valor maximo=1000
    ...
    //Configurando para que sempre que houver uma alteracao nos slidersComer eles chamem o metodo alterarVelocidadeComer para o filosofo especifico
    sliderComer1
      .valueProperty()
    ...
    //Configurando para que sempre que houver uma alteracao nos slidersPensar eles chamem o metodo alterarVelocidadePensar para o filosofo especifico
    sliderPensar1
      .valueProperty()
      .addListener((observable, oldValue, newValue) -> {
